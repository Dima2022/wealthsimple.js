...
var ApiResponse = function () {
  ...
  _createClass(ApiResponse, [{
    ...
    value: function setJson(json) {
      var parsedToken = json.access_token && this.parseJwt(json.access_token);
      if (parsedToken) {
        this.json = json;
    ...
    key: 'getOtpAuthenticatedClaim',
    value: function getOtpAuthenticatedClaim() {
      var otpAuthenticatedClaimString = this.headers.get(constants.OTP_AUTHENTICATED_CLAIM_HEADER);
